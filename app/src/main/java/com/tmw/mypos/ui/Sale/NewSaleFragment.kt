...
class NewSaleFragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        val view = inflater.inflate(R.layout.fragment_new_sale, container, false)

        saleViewModel = ViewModelProvider(this).get(SaleViewModel::class.java)

        view.btn_Save_Sale.setOnClickListener {
    ...
    private fun insertdataintoDatabase() {
        ...
        if (inputCheck(date, customer, code, qty, price)) {
            ...
            Toast.makeText(context, "New Voucher Confirm", Toast.LENGTH_LONG).show()
    ...
    private fun inputCheck(
        ...
        return !(TextUtils.isEmpty(date) && TextUtils.isEmpty(customer) && TextUtils.isEmpty(code) && TextUtils.isEmpty(
            qty.toString()
